...
#frameworkpython3 WslashOspaceUspaceIspaceBlessthanorequalto0-1.py --encodings wouib0_encodings.pickle --input ../examples/bbunny-clip2.mp4 --output output/pickle1wouib0-3.avi --display
