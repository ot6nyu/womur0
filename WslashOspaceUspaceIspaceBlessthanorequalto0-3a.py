...
def face_loc_enc_marks(rgb):
    ...
    return boxes, encodings, landmarks

def face_match(encodings):
...
def face_graffiti(boxes, landmarks, names, frame, r):
...
#                 0.75, (0, 255, 0), 2)
            ...
            for facial_feature in face_landmarks.keys():
                ...
                for x, y in face_landmarks[facial_feature]:
                    ...
                    y *= r
                    xy.append((x, y))
                d.line(xy, fill=(125, 30, 30), width=5)
                print("d.line xy: {}" .format(xy))#           print("face_landmarks: {}" .format(face_landmarks))            print("face_landmarks[facial_feature]: {}" .format(face_landmarks[facial_feature]))
####################################
...
while True:
    ...
    face_graffiti(boxes, landmarks, names, frame, r)
