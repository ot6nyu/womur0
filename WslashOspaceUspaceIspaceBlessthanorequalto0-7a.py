...
#frameworkpython3 WslashOspaceUspaceIspaceBlessthanorequalto0.py --encodings wouib0_encodings.pickle --input ../examples/bbunny-clip2.mp4 --output output/pickle1wouib0- .avi --display 1

#frameworkpython3 WslashOspaceUspaceIspaceBlessthanorequalto0-1.py --encodings wouib0_encodings.pickle --input ../examples/bbunny-blip.mp4 --output output/pickle1wouib0-3.avi
...
#             np.array(open_cv_image)
            pil_image = Image.fromarray(loc_frame)
            d = ImageDraw.Draw(pil_image)
            d.ellipse((left, top, right, bottom), outline=(50, 70, 125))
